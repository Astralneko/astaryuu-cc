...
# <span style="text-shadow: 2px 2px #efefef, 2px 0px #efefef, 2px -2px #efefef, 0px -2px #efefef, -2px -2px #efefef, -2px 0px #efefef, -2px 2px #efefef, 0px 2px #efefef; color: #8dbb82">Traits</span>
<table style="width: 90%;">
	<tr>
		...
		<td style="border: 0px;"><p style="margin: 3px 10px 3px; text-align: right;">
			...
			[starrazors](https://toyhou.se/starrazors)
		</p></td>
	</tr>
</table>
{% endtextbox %}{% textbox 33 %}
# <span style="text-shadow: 2px 2px #efefef, 2px 0px #efefef, 2px -2px #efefef, 0px -2px #efefef, -2px -2px #efefef, -2px 0px #efefef, -2px 2px #efefef, 0px 2px #efefef; color: #8dbb82">Overview</span>
An old robot design, refurbished relatively recently as Madaikaka.
{% endtextbox %}{% textbox 3 %}
# <span style="text-shadow: 2px 2px #efefef, 2px 0px #efefef, 2px -2px #efefef, 0px -2px #efefef, -2px -2px #efefef, -2px 0px #efefef, -2px 2px #efefef, 0px 2px #efefef; color: #8dbb82">Backstory</span>

{% endtextbox %}{% textbox 42 %}
# <span style="text-shadow: 2px 2px #efefef, 2px 0px #efefef, 2px -2px #efefef, 0px -2px #efefef, -2px -2px #efefef, -2px 0px #efefef, -2px 2px #efefef, 0px 2px #efefef; color: #8dbb82">Abilities</span>

{% endtextbox %}{% textbox 2 %}
# <span style="text-shadow: 2px 2px #efefef, 2px 0px #efefef, 2px -2px #efefef, 0px -2px #efefef, -2px -2px #efefef, -2px 0px #efefef, -2px 2px #efefef, 0px 2px #efefef; color: #8dbb82">Social Links</span>
{% endtextbox %}{% textbox 33 %}
<!-- //////////////////// MUSIC PLAYER //////////////////// -->
<div style="float: right; width: 75%;">
	...
	<p style="text-align: right; vertical-align: middle;">
		<span style="font-size: 150%; text-shadow:
			...
			-1px -1px #efefef,
			-1px 1px #efefef;
		color: #8dbb82;"><b>Keep Going!</b></span>
		<br>Nota
	</p>
</div>
...
{% endtextbox %}
{% oc-image "<a href='https://toyhou.se/starrazors'>starrazors</a>" "assets/oc-art/maka/starrazors-20190527.png" %}
{% oc-image "Astaryuu" "assets/oc-art/maka/astaryuu-20190527.png" %}
{% oc-image "Astaryuu" "assets/oc-art/maka/astaryuu-20191112.png" %}
