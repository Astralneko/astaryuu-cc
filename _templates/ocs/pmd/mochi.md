...
# <span style="text-shadow: 2px 2px #efefef, 2px 0px #efefef, 2px -2px #efefef, 0px -2px #efefef, -2px -2px #efefef, -2px 0px #efefef, -2px 2px #efefef, 0px 2px #efefef; color: #ea54ad">Traits</span>
...
# <span style="text-shadow: 2px 2px #efefef, 2px 0px #efefef, 2px -2px #efefef, 0px -2px #efefef, -2px -2px #efefef, -2px 0px #efefef, -2px 2px #efefef, 0px 2px #efefef; color: #ea54ad">Overview</span>
Truly sweet. Mochi is largely based on the dessert she’s named after. A while back, she ate a strange band, which now allows her to give or take "dark energy" from targets.
{% endtextbox %}{% textbox 3 %}
# <span style="text-shadow: 2px 2px #efefef, 2px 0px #efefef, 2px -2px #efefef, 0px -2px #efefef, -2px -2px #efefef, -2px 0px #efefef, -2px 2px #efefef, 0px 2px #efefef; color: #ea54ad">Backstory</span>

{% endtextbox %}{% textbox 42 %}
# <span style="text-shadow: 2px 2px #efefef, 2px 0px #efefef, 2px -2px #efefef, 0px -2px #efefef, -2px -2px #efefef, -2px 0px #efefef, -2px 2px #efefef, 0px 2px #efefef; color: #ea54ad">Abilities</span>

{% endtextbox %}{% textbox 2 %}
# <span style="text-shadow: 2px 2px #efefef, 2px 0px #efefef, 2px -2px #efefef, 0px -2px #efefef, -2px -2px #efefef, -2px 0px #efefef, -2px 2px #efefef, 0px 2px #efefef; color: #ea54ad">Social Links</span>
{% endtextbox %}{% textbox 33 %}
<!-- //////////////////// MUSIC PLAYER //////////////////// -->
<div style="float: right; width: 75%;">
	...
	<p style="text-align: right; vertical-align: middle;">
		<span style="font-size: 150%; text-shadow:
			...
			-1px -1px #efefef,
			-1px 1px #efefef;
		color: #ea54ad;"><b>Keep Going!</b></span>
		<br>Nota
	</p>
</div>
...
{% oc-image "<a href='https://toyhou.se/St3rSh1ne'>St3rSh1ne</a>" "assets/oc-art/mochi/st3rsh1ne-20200223.jpg" %}
{% oc-image "Astaryuu" "assets/oc-art/mochi/astaryuu-20211217.png" %}
{% oc-image "<a href='https://toyhou.se/ThePokeDaycare'>ThePokeDaycare</a>" "assets/oc-art/mochi/thepokedaycare-20220507.png" %}